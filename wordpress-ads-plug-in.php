...
define(ORBITSCRIPTSADS_PLUGIN_HOME, WP_PLUGIN_DIR.'/wordpress-ads-plug-in/');
//get plugin config
...
function orbitscripts_menu() {
    ...
    if ( function_exists('add_menu_page') ) {
        add_menu_page( __('Ads Plugin'), __('Ads Plugin'), 10, 'manage_ads', 'orbitscripts_conf', '../wp-content/plugins/wordpress-ads-plug-in/images/menu.png');
    }
